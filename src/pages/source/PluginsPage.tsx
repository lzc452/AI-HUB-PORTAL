...
export default function PluginsPage() {
  ...
  return <ResourceListView title="插件" description="将代码托管、知识库、数据平台与业务系统接入 AI Hub。" data={result.data} pending={result.isPending} error={result.isError} retry={() => result.refetch()} display={display} onDisplayChange={(value) => setDisplay("plugin", value)} categories={["研发", "知识库", "数据", "协同", "项目"]} />;
}
