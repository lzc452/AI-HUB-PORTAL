...
export default function McpsPage() {
  ...
  return <ResourceListView title="MCP" description="发现可由 AI 安全调用的企业工具、数据与服务连接。" data={result.data} pending={result.isPending} error={result.isError} retry={() => result.refetch()} display={display} onDisplayChange={(value) => setDisplay("mcp", value)} categories={["PostgreSQL", "监控", "搜索", "自动化", "设计"]} />;
}
