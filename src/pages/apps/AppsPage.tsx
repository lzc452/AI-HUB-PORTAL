...
export default function AppsPage() {
  ...
  return <ResourceListView title="全部应用" description="发现经过审核和安全扫描、可在企业内直接使用的 AI 应用。" data={result.data} pending={result.isPending} error={result.isError} retry={() => result.refetch()} display={display} onDisplayChange={setDisplay} categories={["效率", "数据", "研发", "客服", "法务"]} />;
}
