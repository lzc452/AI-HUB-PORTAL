...
export default function SkillsPage() {
  ...
  return <ResourceListView title="全部技能" description="把经过验证的方法、约束与参考资料安装到你的 AI 工作流。" data={result.data} pending={result.isPending} error={result.isError} retry={() => result.refetch()} display={display} onDisplayChange={setDisplay} categories={[...resourceCategories.skill]} />;
}
