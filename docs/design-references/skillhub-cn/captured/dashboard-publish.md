...
- main:
  - complementary:
    ...
    - button "退出登录":
      - text: 退出登录
  - heading "选择发布类型" [level=1]
  - paragraph: 选择要发布的 Skill 类型，进入对应的发布流程
  - link "想更高效？试试通过 CLI 和 Agent 发布 Skill":
    - /url: /tutorials#publish-via-cli
    - generic: ✨
    - text: 想更高效？试试通过 CLI 和 Agent 发布 Skill
    - generic: →
  - button "发布 Skill 最快上架":
    - generic: 发布 Skill
    - generic: 最快上架
- contentinfo:
  - link "SkillHub 首页":
