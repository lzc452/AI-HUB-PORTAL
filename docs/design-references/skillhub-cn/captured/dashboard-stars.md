...
- main:
  - complementary:
    ...
    - button "退出登录":
      - text: 退出登录
  - heading "我的收藏" [level=1]
  - paragraph: 管理你收藏的 Skills，支持批量下载
  - textbox "搜索 Skill 名称或描述"
  - button "最近收藏":
    - generic: 最近收藏
  - button "所有场景分类":
    - generic: 所有场景分类
  ...
  - button "下载" [disabled]:
    - text: 下载
  - checkbox "选择 纸质表单电子化系统生成器"
  - link "纸质表单电子化系统生成器 图标 纸质表单电子化系统生成器 开发编程 V 1.0.29 4 13.4 万":
    - /url: /skills/user_84b8c7d7/paperless-business-system-from-files
    - img "纸质表单电子化系统生成器 图标"
    - heading "纸质表单电子化系统生成器" [level=3]
    - generic: 开发编程
    - generic: V 1.0.29
    - text: "4"
    - text: 13.4 万
